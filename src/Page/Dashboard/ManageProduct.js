...
const ManageProduct = () => {
    ...
    const { data: products, isLoading, refetch } = useQuery('product', () => fetch("https://drill-insomnia-server.onrender.com/tools", {
        method: "GET",
        headers: {
    ...
    return (
        <div>
            <h2 className="text-2xl font-bold pl-6">Manage Products</h2>
